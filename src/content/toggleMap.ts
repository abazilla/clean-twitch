...
export const toggleMap: Record<string, (enabled: boolean) => void> = {
	...
	"hide_left_sidebar_viewers_also_watch": (value: boolean) => toggleLeftSidebarViewersAlsoWatch(value),
	"hide_left_sidebar_recommended_categories": (value: boolean) => toggleLeftSidebarRecommendedCategories(value),
